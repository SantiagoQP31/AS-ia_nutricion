...
export default function Sidebar() {
  ...
  return (
    <div
      className={`bg-gradient-to-b from-indigo-600 to-purple-700 text-white transition-all duration-300 ${collapsed ? "w-16" : "w-64"}`}
    >
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 border-t border-indigo-500/30">
          {!collapsed && <p className="text-xs text-indigo-200">Monitoreo nutricional infantil</p>}
        </div>
      </div>
    </div>
  )
